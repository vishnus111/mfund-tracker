...
// 🔹 1. Login limiter → 5 attempts per minute per IP
...
// 🔹 2. General API limiter → 100 requests per minute per user
...
// 🔹 3. Portfolio update limiter → 10 updates per minute per user
